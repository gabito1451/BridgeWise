...
export class QuoteScoringService {
   ...
   */
  scoreAndRank(quotes: NormalizedQuote[], strategy: RankStrategy = 'score'): NormalizedQuote[] {
  ...
  private sortByStrategy(quotes: NormalizedQuote[], strategy: RankStrategy): NormalizedQuote[] {
    switch (strategy) {
      case 'cost':
