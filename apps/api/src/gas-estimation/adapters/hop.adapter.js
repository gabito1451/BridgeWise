 ...
 */
let HopAdapter = HopAdapter_1 = class HopAdapter {
    constructor(httpService, configService, hopService) {
        this.httpService = httpService;
        this.configService = configService;
        this.hopService = hopService;
        this.logger = new common_1.Logger(HopAdapter_1.name);
...
exports.HopAdapter = HopAdapter = HopAdapter_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [axios_1.HttpService,
        config_service_1.ConfigService,
        hop_service_1.HopService])
], HopAdapter);
