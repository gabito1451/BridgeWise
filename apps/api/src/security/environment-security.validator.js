...
var EnvironmentSecurityValidator_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.EnvironmentSecurityValidator = void 0;
 ...
 */
let EnvironmentSecurityValidator = EnvironmentSecurityValidator_1 = class EnvironmentSecurityValidator {
    constructor() {
        this.logger = new common_1.Logger(EnvironmentSecurityValidator_1.name);
        this.checks = [];
     ...
     */
    checkDevelopmentKeyExposure() {
        const isDevelopment = process.env.NODE_ENV !== 'production';
        const keysInEnv = ['API_KEY', 'API_SECRET', 'DB_PASSWORD'].filter((key) => process.env[key]);
    ...
    getSummary() {
        ...
        const warnings = this.checks.filter((c) => c.severity === 'warning' && !c.isValid).length;
        return {
            passed,
            failed,
            warnings,
...
exports.EnvironmentSecurityValidator = EnvironmentSecurityValidator;
exports.EnvironmentSecurityValidator = EnvironmentSecurityValidator = EnvironmentSecurityValidator_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [])
], EnvironmentSecurityValidator);
//# sourceMappingURL=environment-security.validator.js.map