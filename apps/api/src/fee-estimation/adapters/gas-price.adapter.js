 ...
 */
let GasPriceAdapter = GasPriceAdapter_1 = class GasPriceAdapter {
    constructor(httpService) {
        this.httpService = httpService;
        this.logger = new common_1.Logger(GasPriceAdapter_1.name);
        this.cache = new Map();
...
exports.GasPriceAdapter = GasPriceAdapter = GasPriceAdapter_1 = __decorate([
