...
var PerformanceMetricService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.PerformanceMetricService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const bridge_performance_metric_entity_1 = require("./entities/bridge-performance-metric.entity");
const bridge_benchmark_entity_1 = require("../bridge-benchmark/entities/bridge-benchmark.entity");
/**
 ...
 */
let PerformanceMetricService = PerformanceMetricService_1 = class PerformanceMetricService {
    constructor(metricRepository, benchmarkRepository) {
        this.metricRepository = metricRepository;
        this.benchmarkRepository = benchmarkRepository;
        this.logger = new common_1.Logger(PerformanceMetricService_1.name);
    }
    /**
    ...
    async pruneOldMetrics(timeInterval, olderThan) {
        const result = await this.metricRepository.delete({
            timeInterval,
            timestamp: (0, typeorm_2.LessThan)(olderThan),
        });
...
exports.PerformanceMetricService = PerformanceMetricService = PerformanceMetricService_1 = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(bridge_performance_metric_entity_1.BridgePerformanceMetric)),
    __param(1, (0, typeorm_1.InjectRepository)(bridge_benchmark_entity_1.BridgeBenchmark)),
