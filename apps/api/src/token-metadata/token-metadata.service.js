...
var TokenMetadataService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.TokenMetadataService = exports.GetTokenMetadataDto = void 0;
const common_1 = require("@nestjs/common");
const axios_1 = require("@nestjs/axios");
const config_service_1 = require("../config/config.service");
const token_metadata_constants_1 = require("./token-metadata.constants");
/**
 * Request DTO for fetching token metadata
 */
class GetTokenMetadataDto {
}
exports.GetTokenMetadataDto = GetTokenMetadataDto;
/**
 * Token Metadata Service
 *
 * Provides automatic fetching and caching of token metadata from external APIs.
 */
let TokenMetadataService = TokenMetadataService_1 = class TokenMetadataService {
    constructor(httpService, configService) {
        this.httpService = httpService;
        this.configService = configService;
        this.logger = new common_1.Logger(TokenMetadataService_1.name);
        ...
        this.cacheTtl = token_metadata_constants_1.CACHE_TTL_MS;
     ...
     */
    async fetchFromExternalApi(chainId, tokenAddress) {
     ...
     */
    getDefaultMetadata(chainId, tokenAddress) {
...
exports.TokenMetadataService = TokenMetadataService = TokenMetadataService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [axios_1.HttpService,
        config_service_1.ConfigService])
], TokenMetadataService);
//# sourceMappingURL=token-metadata.service.js.map