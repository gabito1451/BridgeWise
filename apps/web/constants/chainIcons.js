...
const UNKNOWN_SVG = (symbol) => `<svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
function getChainMeta(chainId) {
    return (exports.CHAIN_MAP[chainId] ?? {
        id: chainId,
        name: `Chain ${chainId}`,
        symbol: "???",
        svg: UNKNOWN_SVG("???"),
...
function getAllSupportedChains() {
    return Object.values(exports.CHAIN_MAP).sort((a, b) => a.id - b.id);
}
